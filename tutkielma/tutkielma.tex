...
Tavoitteena on havaita testien avulla lähdekoodiin tehdyt muutokset~\cite[s. 35]{Offutt:Untch:2001}. \textbf{Tähän joku hyvä aloituskappale.}
...
Seuraavaksi testit suoritetaan jokaisen elävän mutantin kohdalla~\cite[s. 35]{Offutt:Untch:2001}. Mutaatiotestausprosessin työvaiheet \textbf{(havainnollistetaan?)}/esitellään kuvassa \ref{figure:Mutaatiotestausprosessi}. Työvaiheet on merkitty kuvaan sinisillä laatikoilla. Työvaiheiden aikana käytettäviä resursseja kuvataan vihreillä ja keltaisilla laatikoilla.
