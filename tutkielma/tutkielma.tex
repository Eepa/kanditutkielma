...
Jotta uutta mutaatiotestausprosessia voitaisiin hyödyntää käytännössä, olisi kehitettävä mutaatiotestausjärjestelmä, joka toteuttaisi uuden prosessin automaattiset ja tehostetut työvaiheet~\cite[s. 41-42]{Offutt:Untch:2001}. \textbf{Voikohan tämän jättää tähän?}
...
Mutaatiotestauksen käyttö yleisesti osana testausprosessia on kuitenkin vähäistä mutaatiotestaukseen liittyvien ratkaisemattomien ongelmien takia. Mutaatiotestausta on tutkittu paljon. Tutkimuksen \textbf{tavoitteena} on ollut etsiä ratkaisuja mutaatiotestaukseen liittyviin haasteisiin ja ongelmiin. Tutkimuksesta saatujen tietojen \textbf{pohjalta} haasteisiin ja ongelmiin on kehitetty osittaisia ratkaisuja, joiden avulla mutaatiotestausprosessi on mahdollista automatisoida \textbf{lähes kokonaan}.

Jotta mutaatiotestausmenetelmää voitaisiin tulevaisuudessa hyödyntää myös tutkimuskäytön ulkopuolella, mutaatiotestauksen käyttöönoton helpottamiseksi olisi kehitettävä automatisoituja mutaatiotestausjärjestelmiä, joissa hyödynnettäisiin mutaatiotestauksen ongelmien ratkaisumenetelmiä. Automatisoitujen mutaatiotestausjärjestelmien avulla mutaatiotestausmenetelmä voisi olla mahdollista ottaa laaja-alaisesti käyttöön osaksi ohjelmistokehitystä.
