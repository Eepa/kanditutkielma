...
Testaukseen liittyy kuitenkin myös rajoituksia. Sen avulla ei voi esimerkiksi todeta ohjelmiston oikeellisuutta. Tähän liittyen Dijkstra kirjoitti seuraavan korollaarin liittyen ohjelmistojen oikeaksi todistamiseen: \textit{''Program testing can be used to show the presence of bugs, but never to show their absence!''}~\cite[s. 6]{Dahl:Dijkstra:Hoare:1972}. 
...
Testien suunnittelussa ja kehittämisessä voidaan myös käyttää erilaisia suunnittelumalleja, joiden avulla testien suunnitteluun käytettävää näkökulmaa voidaan kuvata. Ohjelman sisäiseen rakenteeseen eli ohjelmiston lähdekoodin tuntemukseen perustuvaa suunnittelumallia kutsutaan \textit{white box -testaukseksi} (\textit{white box testing}). \textit{Black box -testaukseksi} (\textit{black box testing}) tai \textit{funktionaaliseksi testaukseksi} (\textit{functional testing}) kutsutussa suunnittelumallissa testejä suunnitellaan analysoimalla ohjelmiston ulkoista toiminnallisuutta~\cite[s. 52]{Binder:1999}.

Vaikka testauksen avulla ei voikaan varmistua ohjelmiston oikeellisuudesta, voidaan sitä käyttää välineenä ohjelmiston laadun parantamisessa. Testaukseen liittyy kuitenkin myös epävarmuutta käytettävän testausjärjestelmän oikeellisuudesta ja oikeellisuuden varmistamisesta~\cite{Manna:Waldinger:1978}. Tämä herättää kysymyksen siitä, kuka voi valvoa valvojia eli kuinka varmistetaan ohjelmiston testien laadukkuus.
